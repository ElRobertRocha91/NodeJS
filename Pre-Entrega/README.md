# Pre-Entrega Proyecto Final [Backend en Node.js]

## Requerimientos del Proyecto

### Requerimiento N° 1: Configuración Inicial

- Crear un directorio donde se alojara el proyecto e incluyendo un archivo `index.js` como punto de entrada.
...
Con la base del proyecto lista, ahora necesitamos implementar las funcionalidades principales usando la API FakeStore ([Ver Documentación](https://fakestoreapi.com/docs)). El sistema debe ser capaz de interpretar comandos ingresados en la terminal y ejecutar las siguientes acciones: 
